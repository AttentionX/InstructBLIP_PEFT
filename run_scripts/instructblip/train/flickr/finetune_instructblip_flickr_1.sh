...
python3 -m torch.distributed.run --nproc_per_node=1 train.py --cfg-path lavis/projects/instructblip/train/flickr/finetune_instructblip_flickr_1.yaml 2>&1 | tee /output/results/flickr/flickr_1/flickr_1.log
wait
